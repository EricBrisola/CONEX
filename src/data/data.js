const data = [
  {
    ...
    modalStyles: {
      mainContainer: "relative flex gap-7",
      cardContainer:
        "shadow-modalCustom relative h-[17.75rem] w-[24.5rem] rounded-bl-[4.75rem] rounded-br-[4.75rem] rounded-tl-[11.1875rem] rounded-tr-[4.75rem] bg-white",
      imageStyle: "absolute left-[2.125rem] top-6",
      textContainer:
        "flex flex-col items-center justify-center gap-3 font-JosefinSans",
      titleText: "text-2xl font-bold",
      mainText: "w-[27.938rem] text-center text-xl font-light",
      absoluteText:
        "absolute bottom-0 right-2 text-center font-ReenieBeanie text-[4.0625rem] leading-none",
    },
  },
  {
    id: 1,
    ...
    modalStyles: {
      mainContainer:
        "relative flex justify-center flex-row-reverse gap-[2.438rem]",
      cardContainer:
        "shadow-circleCustomModal relative h-[17.7375rem] w-[17.7375rem] rounded-full bg-white",
      imageStyle: "absolute bottom-9 right-4",
      textContainer:
        "flex flex-col items-center justify-center gap-3 font-JosefinSans",
      titleText: "text-2xl font-bold",
      mainText: "w-[27.938rem] text-center text-xl font-light",
      absoluteText:
        "absolute -bottom-[1.5rem] right-[2.8rem] text-center font-ReenieBeanie text-[4.0625rem] leading-none",
    },
  },
  {
    id: 2,
    ...
    textStyle: "text-wrap text-lg font-light leading-[1.51]",
    modalStyles: {
      mainContainer: "relative flex w-[57rem] justify-center gap-[1.9rem]",
      cardContainer:
        "relative h-[17.563rem] w-[21.75rem] rounded-bl-[9.38rem] rounded-br-[6.25rem] rounded-tl-[12.5rem] rounded-tr-[12.5rem] bg-[#edf0eb] shadow-circleCustomModal",
      imageStyle: "absolute -bottom-4 left-[3.3rem]",
      textContainer:
        "flex flex-col items-center justify-center font-JosefinSans",
      titleText: "text-2xl font-bold",
      mainText: "w-[30rem] text-center text-xl font-light",
      absoluteText:
        "absolute -bottom-3 -right-6 text-center font-ReenieBeanie text-[4.0625rem] leading-none",
    },
  },
  {
    id: 3,
    ...
    modalStyles: {
      mainContainer:
        "relative flex justify-center flex-row-reverse gap-[2.438rem] pt-3",
      cardContainer:
        "relative h-[15.438rem] w-[18.625rem] rounded-bl-[5rem] rounded-br-[6.25rem] rounded-tl-[5rem] rounded-tr-[15.625rem] bg-white shadow-circleCustomModal",
      imageStyle: "absolute bottom-2 right-14",
      textContainer:
        "flex flex-col items-center justify-center gap-1 font-JosefinSans",
      titleText: "text-2xl font-bold",
      mainText: "w-[27.938rem] text-center text-xl font-light",
      absoluteText:
        "absolute -bottom-[1.2rem] right-[3.4rem] text-center font-ReenieBeanie text-[4.0625rem] leading-none",
    },
  },
  {
    id: 4,
    ...
    textStyle: "text-wrap text-lg font-light leading-[1.51]",
    modalStyles: {
      mainContainer: "relative flex justify-center gap-[2.106rem]",
      cardContainer:
        "shadow-circleCustomModal relative h-[17.7375rem] w-[17.7375rem] rounded-full bg-[#edf0eb]",
      imageStyle: "absolute bottom-4 left-0",
      textContainer:
        "flex flex-col items-center justify-center gap-2 font-JosefinSans",
      titleText: "text-2xl font-bold",
      mainText: "w-[34rem] text-center text-xl font-light",
      absoluteText:
        "absolute -bottom-[1rem] right-8 text-center font-ReenieBeanie text-[4.0625rem] leading-none",
    },
  },
];
